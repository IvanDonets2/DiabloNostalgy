...
public class StableNMPlayer : MonoBehaviour {
    ...
    public Transform PlayerTransform, EnemyTransform, ItemTransform;    // Selectible with mouse 
    ...
    void OnGUI()
    {
        ...
        // if (Event.current.type == EventType.Repaint)
        {
            ...
            if (GUI.Button(new Rect(0, 60, 50, 20), "Save"))
            {
                ...
                SaveLoadScript.SaveFileInt("samuraiSave", HeroHealth);
            ...
            if (GUI.Button(new Rect(0, 80, 50, 20), "Load"))
            {
                ...
                HeroHealth = SaveLoadScript.LoadFileInt("samuraiSave");
